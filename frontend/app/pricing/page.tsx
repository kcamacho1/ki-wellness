  ...
  return (
    <main className="min-h-screen bg-green-900 text-white p-6 font-sans">
      <section className="max-w-5xl mx-auto text-center space-y-4">
        <h1 className="text-4xl font-bold text-amber-300">🌱 Ki Wellness Pricing</h1>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mt-8">
          ...
          <div className="bg-amber-50 text-gray-900 p-6 rounded-xl shadow-lg space-y-4">
            ...
            <div className="space-y-1 text-left text-sm mt-4" style={{ listStyle: 'none' }}>
            ...
            <button className="w-full bg-green-700 hover:bg-green-800 text-white py-2 rounded mt-4">
