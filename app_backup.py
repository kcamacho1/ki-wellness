...
# Stripe for premium subscriptions, Calendly for human help booking
...
from database import db, User, FoodLog, WaterLog, MoodLog, Note, Recipe, RecipeIngredient, RecipeInstruction, Subscription, AIUsageLog, AppSettings, PaymentSession, AIAnalysis
...
from utils.helpers import get_app_setting, set_app_setting, check_ai_usage_limits, initialize_default_settings

# Using Cloudflare bot protection for spam prevention
...
# Admin settings routes moved to routes/admin.py
# Admin analytics route moved to routes/admin.py
# Admin AI usage route moved to routes/admin.py
# AI usage route moved to routes/api.py
# Admin revenue route moved to routes/admin.py
# Admin assign FF roles route moved to routes/admin.py
# Admin users and analytics page routes moved to routes/admin.py
...
# Admin routes have been moved to routes/admin.py blueprint

# OpenRouter model configuration - using cloud-based AI only
# Local AI model configurations have been removed

# User data analysis route moved to routes/api.py

# Stored analysis route moved to routes/api.py
...
# Recipe page route moved to routes/dashboard.py
